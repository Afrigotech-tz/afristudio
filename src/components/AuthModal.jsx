...
import { FiX, FiMail, FiPhone, FiUser, FiLock, FiArrowRight } from './Icons'
import { useAuth } from '../context/AuthContext'
import './AuthModal.css'

export default function AuthModal() {
  const { isAuthModalOpen, authMode, closeAuthModal, login } = useAuth()
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      const userData = {
        name: formData.name || (identifierType === 'email' ? formData.email : formData.phone),
        email: identifierType === 'email' ? formData.email : null,
        phone: identifierType === 'phone' ? formData.phone : null,
      }
      login(userData)
      setIsLoading(false)
      setFormData({
